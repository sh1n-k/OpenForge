...
enum class OrderMode(
    ...
    companion object {
        @JvmStatic
        @JsonCreator
        fun fromValue(value: String): OrderMode =
...
enum class OrderRequestStatus(
    ...
    companion object {
        @JvmStatic
        @JsonCreator
        fun fromValue(value: String): OrderRequestStatus =
            entries.firstOrNull { it.value == value }
...
enum class OrderLifecycleStatus(
    ...
    companion object {
        @JvmStatic
        @JsonCreator
        fun fromValue(value: String): OrderLifecycleStatus =
            entries.firstOrNull { it.value == value }
                ?: throw IllegalArgumentException("Unsupported orderLifecycleStatus: $value")
    }
}

enum class OrderFillSource(
    @get:JsonValue val value: String,
) {
    ...
    companion object {
        @JvmStatic
        @JsonCreator
        fun fromValue(value: String): OrderFillSource =
            entries.firstOrNull { it.value == value }
                ?: throw IllegalArgumentException("Unsupported orderFillSource: $value")
    }
}

enum class RiskEventScope(
    @get:JsonValue val value: String,
) {
    STRATEGY("strategy"),
    GLOBAL("global"),
    ...
    companion object {
        @JvmStatic
        @JsonCreator
        fun fromValue(value: String): RiskEventScope =
            entries.firstOrNull { it.value == value }
                ?: throw IllegalArgumentException("Unsupported riskEventScope: $value")
    }
}

enum class StrategyRiskEventType(
    @get:JsonValue val value: String,
) {
    ...
    companion object {
        @JvmStatic
        @JsonCreator
        fun fromValue(value: String): StrategyRiskEventType =
            entries.firstOrNull { it.value == value }
