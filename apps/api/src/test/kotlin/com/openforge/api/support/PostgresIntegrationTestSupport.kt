...
@TestPropertySource(
    properties = [
        ...
        "app.mode=paper",
        "app.live-trading.enabled=false",
...
abstract class PostgresIntegrationTestSupport {
    ...
    fun cleanupData() {
        jdbcTemplate.execute(
            "truncate table symbol_master, symbol_master_status, strategy_trade_audit_log, strategy_rebalance_plan_order, strategy_rebalance_plan, broker_ledger_profit_snapshot, broker_ledger_balance_snapshot, broker_ledger_trade_entry, broker_ledger_sync_run, broker_connection_event, broker_connection_config, strategy_risk_event, strategy_risk_config, strategy_order_fill, strategy_order_status_event, strategy_order_request, strategy_signal_event, strategy_execution_run, strategy_execution_config, app_event_log, app_config, backtest_equity_point, backtest_trade, backtest_run, market_daily_bar, strategy_universe, universe_symbol, strategy_version, strategy, universe restart identity cascade",
        )
    }
