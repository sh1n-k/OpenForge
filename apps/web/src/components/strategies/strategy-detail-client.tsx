...
import { StrategyExecutionSection } from "@/components/strategies/strategy-execution-section";
import { StrategyInfoPanel } from "@/components/strategies/strategy-overview-section";
import { StrategyRiskSection } from "@/components/strategies/strategy-risk-section";
import { StrategyVersionsSection } from "@/components/strategies/strategy-versions-section";
import { StrategyOrdersSection } from "@/components/strategies/strategy-orders-section";
import { StrategyActivitySection } from "@/components/strategies/strategy-activity-section";
  ...
  return (
    <main className="page-shell docs-page-shell">
      <section className="doc-panel">
        ...
        {actionError ? (
          <ErrorBanner style={{ marginTop: 16 }}>{actionError}</ErrorBanner>
        ) : null}
