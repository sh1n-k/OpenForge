      ...
      >
        <div className="page-intro-row">
          ...
          <div className="page-actions">
            ...
            <span className="status-chip status-chip-info">{resolvedSymbols.length}개 종목</span>
          </div>
        </div>
        ...
        <div className="summary-grid summary-grid-columns-3" style={{ marginTop: 16 }}>
          <article className="metric-card metric-card-accent-primary">
            ...
            <p className="metric-card-value">
              v{versions.find((version) => version.id === selectedVersionId)?.versionNumber ?? "?"}
            </p>
          ...
          <article className="metric-card metric-card-accent-info">
            ...
            <p className="metric-card-value">{resolvedSymbols.length}</p>
